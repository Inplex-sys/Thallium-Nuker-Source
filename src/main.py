                                ...
                                if ans in ["8", "08"]:
                                    ...
                                    if ans in ["9", "09"]:
                                        ...
                                        if ans in ["6", "06"]:
                                            ...
                                            spammer = "@everyone [Nuked By Thallium](<https://github.com/Inplex-sys/Thallium-Nuker-Source>)"
                                            amount = int(
                                                input(
                                                    "{}({}Thallium{}) Amount{}:{} ".format(
                                                        "\x1b[0m",
                                                        ...
                                                        if ans == "13":
                                                            try:
                                                                response = self.session.get(
                                                                    "https://github.com/Inplex-sys/Thallium-Nuker-Source/releases/latest"
                                                                )
                                                                check_version = (
                                                                ...
                                                                if (
                                                                    ...
                                                                    webbrowser.open(
                                                                        f"https://github.com/Inplex-sys/Thallium-Nuker-Source/releases/tag/{check_version}0"
                                                                    )
                                                                else:  # inserted
                                                                    print(
                                                            ...
                                                            if ans == "14":
                                                                print(
                                                                    "{}({}Thallium{}) https://github.com/Inplex-sys/Thallium-Nuker-Source".format(
                                                                        "\x1b[0m",
                                                                        "\x1b[90m",
                                                                        "\x1b[0m",
                                                                    )
